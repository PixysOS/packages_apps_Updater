...
public class UpdatesActivity extends UpdatesListActivity implements CurrentActionInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            List<UpdateInfo> infos = Utils.parseJson(jsonFile, false);
            maintainerName.setText(infos.get(0).getMaintainer());
        } catch (Exception e) {
            Log.e(TAG, "onCreate: Fetching Maintainers failed", e);
        ...
        if (maintainerName.getText().toString().contains(" and "))
            maintainerText.setText(maintainerText.getText().toString() + "s");
    ...
    public void showSnackbar(int stringId, int duration) {
        ...
        ((TextView) snackbar.getView().findViewById(com.google.android.material.R.id.snackbar_text)).setTextColor(ContextCompat.getColor(this, R.color.theme_primary));
        snackbar.show();
    }
